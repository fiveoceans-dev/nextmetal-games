        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 animate-fade-in-up">
              <div className="w-80 h-80 rounded-full border-2 border-foreground/15 flex items-center justify-center hover:border-foreground/30 transition-all duration-500 bg-card">
