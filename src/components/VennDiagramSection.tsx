        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 animate-fade-in-up">
              <div className="w-72 h-72 rounded-full border border-foreground/20 flex items-center justify-center hover:border-foreground/40 transition-all">
                <div className="text-center">
                  <h3 className="text-3xl font-semibold mb-3">LoL Players</h3>
                  <p className="text-base text-muted-foreground px-8">Skilled gamers seeking rewards</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-0 left-1/4 transform -translate-x-1/2 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              <div className="w-72 h-72 rounded-full border border-foreground/20 flex items-center justify-center hover:border-foreground/40 transition-all">
                <div className="text-center">
                  ...
                  <p className="text-base text-muted-foreground px-8">Onchain gaming community</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-0 right-1/4 transform translate-x-1/2 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <div className="w-72 h-72 rounded-full border-2 border-foreground flex items-center justify-center hover:scale-105 transition-all">
                <div className="text-center">
                  <h3 className="text-4xl font-bold mb-3 tracking-tight">$POKER</h3>
                  <p className="text-base text-muted-foreground px-8">Airdrop for verified players</p>
                </div>
              </div>
            </div>
          </div>
